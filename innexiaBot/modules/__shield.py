...
from innexiaBot.utils.pluginhelpers import is_admin
from innexiaBot.events import register
from innexiaBot.modules.sql.nsfw_watch_sql import (
    add_nsfwatch,
    get_all_nsfw_enabled_chat,
    is_nsfwatch_indb,
    rmnsfwatch,
)
from innexiaBot import telethn, MONGO_DB_URI, BOT_ID
...
__help__ = """
• Phoenix can protect your group from NSFW senders, Slag word users and also can force members to use English
*Commmands:*
