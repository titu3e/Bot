...
async def hmm(_, message):
    ...
    if status == "ON" or status == "on" or status == "On":
        ...
        if not lol:
            await lel.edit("Phoenix AI Already Activated In This Chat")
            return
        await lel.edit(
            f"Phoenix AI Successfully Added For Users In The Chat {message.chat.id}"
        )
        ...
        if not Escobar:
            await lel.edit("Phoenix AI Was Not Activated In This Chat")
            return
        await lel.edit(
            f"Phoenix AI Successfully Deactivated For Users In The Chat {message.chat.id}"
        )
